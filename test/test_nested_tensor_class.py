...
class TestNestedTensor(TestCase):
    ...
    def test_constructor(self):
        ...
        for constructor in _iter_constructors():
            nested_tensor = constructor(tensors)
            for i in range(num_tensors):
                tensors[i].mul_(i + 2)
            for i in range(num_tensors):
        ...
        for constructor in _iter_constructors():
            self.assertRaises(
                ValueError, lambda: constructor(torch.tensor([3.0])))
            for constructor2 in _iter_constructors():
                self.assertRaises(ValueError, lambda: constructor(
    ...
    def test_scalar_constructor(self):
        ...
        self.assertRaises(
            RuntimeError, lambda: nestedtensor.nested_tensor([1.0]))
