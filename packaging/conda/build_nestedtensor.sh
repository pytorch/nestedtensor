...
echo "Building cuda version $desired_cuda and nestedtensor version: $build_version build_number: $build_number"
...
for py_ver in "${DESIRED_PYTHON[@]}"; do
    ...
    cp ../$VSTOOLCHAIN_PACKAGE/conda_build_config.yaml ../nestedtensor/conda_build_config.yaml
    ...
    built_package="$(find $output_folder/ -name '*nestedtensor*.tar.bz2')"
