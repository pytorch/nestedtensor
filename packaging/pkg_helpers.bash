...
#   FORCE_CUDA (respected by nestedtensor setup.py)
#   NVCC_FLAGS (respected by nestedtensor setup.py)
#
...
setup_visual_studio_constraint() {
  if [[ "$OSTYPE" == "msys" ]]; then
      ...
      cp packaging/$VSTOOLCHAIN_PACKAGE/conda_build_config.yaml packaging/nestedtensor/conda_build_config.yaml
  fi
}
