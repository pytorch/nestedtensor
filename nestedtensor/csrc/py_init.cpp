...
//      .def("__repr__", &torch::nested_tensor::THP_ListNestedTensor::str);
  ...
  // since you can expect transparent changes to the constiuents
  // via unbind.
  py::class_<torch::nested_tensor::THPNestedTensor>(
      ...
      .def_property_readonly("grad", &torch::nested_tensor::THPNestedTensor::grad)
      .def("detach", &torch::nested_tensor::THPNestedTensor::detach)
      .def("dim", &torch::nested_tensor::THPNestedTensor::dim)
      .def(
          "pin_memory", &torch::nested_tensor::THPNestedTensor::pin_memory)
      .def(
          "nested_dim",
          &torch::nested_tensor::THPNestedTensor::nested_dim)
      .def(
          "is_pinned", &torch::nested_tensor::THPNestedTensor::is_pinned)
      .def(
          "is_contiguous",
          &torch::nested_tensor::THPNestedTensor::is_contiguous)
      .def(
          "get_buffer",
          &torch::nested_tensor::THPNestedTensor::get_buffer)
  ...
  m.def("_buffer_nested_tensor" &torch::nested_tensor::_buffer_nested_tensor);
}
