...
Tensor transpose_buffer(Tensor nt_sizes_, Tensor input_buffer, Tensor output_buffer) {
  ...
  at::Tensor all_meta = at::cat({offsets, block_offsets, blocks_batch_dim, sizes_dim2, sizes_dim3});
  // at::Tensor all_meta = at::cat({offsets, block_offsets, blocks2, blocks3, blocks_batch_dim, sizes_dim2, sizes_dim3});
  ...
  // blocks2 = split_all_meta[2];
  // blocks3 = split_all_meta[3];
  blocks_batch_dim = split_all_meta[2];
  sizes_dim2 = split_all_meta[3];
  sizes_dim3 = split_all_meta[4];
